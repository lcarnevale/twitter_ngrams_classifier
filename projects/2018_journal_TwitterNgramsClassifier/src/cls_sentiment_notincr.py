...
# save on csv
ofile = open('../results/result-notincr_acc.csv', 'wb')
...
ax.grid()
fig.savefig("../results/vocabulary_size.png")
...
ax.grid()
fig.savefig("../results/naivebayes-notincr_acc.png")
...
ax.legend(loc='lower left')
ax.grid()
fig.savefig("../results/linearmodel-notincr_acc.png")
...
ax.legend(loc='lower left')
ax.grid()
fig.savefig("../results/svm-notincr_acc.png")

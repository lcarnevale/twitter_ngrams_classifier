...
# save on csv
ofile = open('../results/result-incr_acc.csv', 'wb')
...
ax.grid()
fig.savefig("../results/vocabulary-incr_size.png")
...
ax.grid()
fig.savefig("../results/naivebayes-incr_acc.png")
...
ax.legend(loc='lower left')
ax.grid()
fig.savefig("../results/linearmodel-incr_acc.png")
...
ax.legend(loc='lower left')
ax.grid()
fig.savefig("../results/svm-incr_acc.png")
